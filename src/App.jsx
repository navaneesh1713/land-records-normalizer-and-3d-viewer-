    ...
    if (Array.isArray(props.floors) && props.floors.length > 0) {
      ...
      if (div) {
        firstUnit = {
          ...
          building_name: props.building_name || div.building_name || '',
          house_number: props.house_number || div.house_number || '',
          street_name: props.street_name || div.street_name || '',
          locality: props.locality || div.locality || '',
          village: props.village,
          tehsil: props.tehsil,
          district: props.district,
          state: props.state || div.state || '',
          pincode: props.pincode || div.pincode || '',
          latitude: center.latitude,
          longitude: center.longitude,
